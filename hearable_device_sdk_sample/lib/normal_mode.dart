...
class _Normal_mode extends StatefulWidget {
  @override
  State<_Normal_mode> createState() => _Normal_modeState();
}

class _Normal_modeState extends State<_Normal_mode>
  ...
  void initState() {
    ...
    // BGMの設定
    bgm.play(AssetSource('Ray_Engine.mp3'));
    bgm.setVolume(0.1);
  ...
  void trainShakeHandler() {
    ...
    if (nextShakeTime <= 0) {
      ...
      nextShakeTime = math.Random().nextInt(4 - level ~/ 3) +
          3; // Level:second 0~2:3~6s 3~5:3~5s 6~8:3~4s 9,10:3s
  ...
  void updateScore() {
    // スコア加算の処理
    score += NineAxisSensor().peopleX.toInt().abs();
  }
    ...
    return Scaffold(
        ...
        body: Container(
            decoration: const BoxDecoration(
              ...
              image: AssetImage('assets/bg_train.jpg'),
                    ...
                    child: Row(
                      ...
                      children: [
                        Image.asset(
                          ...
                          height: 100,
                          width: 100,
                        ), // leftAttentionには注意マークか透過画像のパスが入っているため、そのまま出力
                        const SizedBox(
                          width: 400,
                        ),
                        Image.asset(
                          ...
                          height: 100,
                          width: 100,
                        ), // rightAttentionには注意マークか透過画像のパスが入っているため、そのまま出力
                      ],
                    ),
                  );
                },
                              ...
                              return Column(
                                ...
                                children: <Widget>[
                                  Consumer<NineAxisSensor>(
                                    ...
                                    String people_img =
                                        'assets/default_standing.png';
                                    String shadow_img =
                                        'assets/default_standing_shadow.png';

                                    // 端に行くと画像が変化
                                    if (people_x < -250) {
                                      people_img = 'assets/left_standing.png';
                                      shadow_img =
                                          'assets/left_standing_shadow.png';
                                    }
                                    if (people_x > 250) {
                                      people_img = 'assets/right_standing.png';
                                      shadow_img =
                                          'assets/right_standing_shadow.png';
                                    }
